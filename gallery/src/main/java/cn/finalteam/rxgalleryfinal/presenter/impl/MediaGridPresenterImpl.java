...
public class MediaGridPresenterImpl implements MediaGridPresenter, MediaSrcFactoryInteractor.OnGenerateMediaListener,
    ...
    public MediaGridPresenterImpl(Context context, boolean isImage, boolean isCache) {
        this.context = context;
        this.mediaSrcFactoryInteractor = new MediaSrcFactoryInteractorImpl(context, isImage,isCache, this);
